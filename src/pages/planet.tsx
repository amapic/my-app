            ...
            <div className="row gx-2">
              <div className="col-10">
                ...
                <h3 className="feature-title text-center">Historique</h3>
                  En 1995, la première exoplanète est découverte par Michel Mayor à l'observatoire de Haute Provence
                  ...
                  De plus en plus de planète sont trouvées au fil des ans grâce à de nouveau instrument.
                  Egalement, des systèmes solaires entier commencent à être connus.
