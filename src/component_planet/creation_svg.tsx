        ...
        <div style={{ margin: "0px 0 0 22px", width: width.toString() + "%" }}>
            <>
                <svg width="100%" height="50" viewBox="0 0 100% 50" >
                    <line x1="1" y1="10" x2="1" y2="15" stroke="black" stroke-width={strokeWidth} />
                    <line x1="1" y1="15" x2="98%" y2="15" stroke="black" stroke-width={strokeWidth} />

                    <line x1="98%" y1="15" x2="98%" y2="10" stroke="black" stroke-width={strokeWidth} />
                    <text alignment-baseline="middle" text-anchor="middle" fontFamily="Roboto, Helvetica, Arioal, sans-serif" x="50%" y="28" fill="black">{texte}</text>
                </svg>
